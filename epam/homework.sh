...
mkfs.xfs /dev/md5 && echo SUCCESS create file system for raid devices
...
echo 'UUID='$tempUUID'     /raid5   xfs     defaults 0 0' >> /etc/fstab && echo SUCCESS mount the RAID using UUID
...
mount -t xfs /dev/vg1/lvr5 /mnt/lvr5 && echo SUCCESS mount for raid
